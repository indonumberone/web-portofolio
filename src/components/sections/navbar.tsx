              ...
              {item.href.startsWith("#") ? (
                ...
                >
                  <span className="relative">
                    {item.label}
                    <motion.div
                      className="absolute left-0 right-0 -bottom-1 h-0.5 bg-primary rounded"
                      initial={{ scaleX: 0 }}
                      whileHover={{ scaleX: 1 }}
                      transition={{
                        type: "spring",
                    ...
                    <div key={item.href}>
                      {item.href.startsWith("#") ? (
                        <button
                          onClick={() => handleNavClick(item.href)}
                          className={cn(
                            "w-full flex items-center rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground text-left",
